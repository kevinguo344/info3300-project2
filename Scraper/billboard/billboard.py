#Original Source - https://github.com/mwkling/umdmusic-downloader
import re
import tsv
...
def main():
    s = session()
    request_path = "http://www.umdmusic.com/default.asp?Lang=English&Chart=E"
    out_file = "us_billboard.tsv"
